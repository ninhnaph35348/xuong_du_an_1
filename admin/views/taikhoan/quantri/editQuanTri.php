                        ...
                        <form action="<?= BASE_URL_ADMIN . '?act=sua-quan-tri' ?>" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Họ Tên</label>
                                    <input type="text" class="form-control" name="ho_ten" placeholder="Nhập tên họ tên" value="<?= $quanTri['ho_ten'] ?>">
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control" name="email" placeholder="Nhập tên email" value="<?= $quanTri['email'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="so_dien_thoai" value="<?= $quanTri['so_dien_thoai'] ?>" placeholder="Nhập tên số điện thoại">
